const TENOR_API_KEY = 'AIzaSyA497MbJK6lzNQ9VIGvUyxWG6QLzjndJm8';
...
class TenorAPI {
  ...
  constructor(apiKey?: string) {
    this.apiKey = apiKey || TENOR_API_KEY;
  }
  ...
  convertGifToAttachedImage(gif: TenorGif): {
    ...
    const gifUrl = gif.media_formats.gif?.url || gif.media_formats.tinygif?.url || gif.media_formats.nanogif?.url || gif.url; // fallback to the main URL
