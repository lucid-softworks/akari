...
/**
 * Renders the title + description block beneath the video surface.
 * Returns null when neither field has visible content so the parent
 * doesn't paint an empty caption row.
 */
