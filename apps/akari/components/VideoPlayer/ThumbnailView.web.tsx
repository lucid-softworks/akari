...
import { VideoCaption } from './VideoCaption.web';
...
/**
 * Pre-playback poster + play button overlay for the web video player.
 * Renders the optional caption beneath via VideoCaption.
 */
