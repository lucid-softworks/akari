...
export default function DebugScreen() {
  ...
  const invalidateAllQueries = () => {
    Alert.alert(
      ...
      "Are you sure you want to invalidate all queries? This will refetch all data.",
      [
        { text: "Cancel", style: "cancel" },
        {
          text: "Invalidate",
                  ...
                  >
                    <View style={styles.queryHeaderLeft}>
                      ...
                      <ThemedText style={styles.queryKey}>
                        {queryKeyString.length > 100
                          ? queryKeyString.substring(0, 100) + "..."
                          : queryKeyString}
                      </ThemedText>
                    </View>
