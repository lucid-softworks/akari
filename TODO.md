...
- **Verification badges + verifier system.** Blue check rendering on
  posts and profiles, `VerificationsDialog`, `VerifierDialog`, settings
  toggle to opt out of seeing verification.
